...
public class MeasureImgHorizontalScrollViewAdapter extends BaseAdapter {

	private Context mContext;
	private LayoutInflater mInflater;
	private ArrayList<FullImageMeasureModel> mDatas;

	protected ImageLoader imageLoader;
	DisplayImageOptions options;

	public MeasureImgHorizontalScrollViewAdapter(Context context, ArrayList<FullImageMeasureModel> mDatas) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.mText.setText(mDatas.get(position).getPmgAddtime().replace(" ", "\r\n  "));
		imageLoader.displayImage(mDatas.get(position).getPmgPath(), viewHolder.mImg, options,
