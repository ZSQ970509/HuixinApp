...
public class FullImageSupervisionBaseAdapter extends BaseAdapter {
	...
	Context Context;
	Handler Handler;
	ArrayList<FullImageNodeModel> list;

	public FullImageSupervisionBaseAdapter(Context Context, Handler Handler, ArrayList<FullImageNodeModel> result) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		imageLoader.displayImage(list.get(position).getPath(), viewHolder.mImg, options, new ImageLoadingListener() {
