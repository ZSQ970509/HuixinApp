...
/**
 * Implementation for Android API 9 (Gingerbread) and later. This opens up the
 * possibility of accessing front cameras, and rotated cameras.
 */
@TargetApi(9)
