...
public class MobileInfoUtils {
    ...
    public static void jumpBattery(Context context) {
        MobileTypeEnum mobileTypeEnum = getMobileTypes(context);
        ArrayList<PackageAndActivity> arrayList = mobileTypeEnum.getmBattery();
        if(getMobileType().equals("Xiaomi")){
            toHiddenAppList(context,arrayList);
        }else{
    ...
    public static void jumpAutoStarty(Context context) {
        MobileTypeEnum mobileTypeEnum = getMobileTypes(context);
        ArrayList<PackageAndActivity> arrayList = mobileTypeEnum.getmAutoStarty();
        jumpBattery(context, arrayList, 0);
    }

    public static MobileTypeEnum getMobileTypes(Context context) {
        MobileTypeEnum mobileTypeEnum = null;
        switch (getMobileType()) {
            case "Xiaomi":
                mobileTypeEnum = MobileTypeEnum.XIAOMI;
                break;
            case "Letv":
                mobileTypeEnum = MobileTypeEnum.LETV;
                break;
            case "HUAWEI":
                mobileTypeEnum = MobileTypeEnum.HUAWEI;
                break;
            case "Coolpad":
                mobileTypeEnum = MobileTypeEnum.COOLPAD;
                break;
            case "Lenovo":
                mobileTypeEnum = MobileTypeEnum.LENOVO;
                break;
            case "Meizu":
//                mobileTypeEnum=  null;
                mobileTypeEnum = MobileTypeEnum.MEIZU;
                break;
            case "samsung":
                mobileTypeEnum = MobileTypeEnum.SAMSUNG;
                break;
            case "Smartisan":
                mobileTypeEnum = MobileTypeEnum.SMARTISAN;
                break;
            case "vivo":
                mobileTypeEnum = MobileTypeEnum.VIVO;
                break;
            case "zte":
                mobileTypeEnum = MobileTypeEnum.ZTE;
                break;
            case "OPPO":
                mobileTypeEnum = MobileTypeEnum.OPPO;
                break;
        }
