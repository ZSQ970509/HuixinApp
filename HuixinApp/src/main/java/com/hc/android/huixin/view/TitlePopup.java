...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, int width, int height) {
		...
		setContentView(LinearLayout.inflate(context, R.layout.title_popup, null));
	...
	public void show(View view) {
		...
		// showAtLocation(view,
		// popupGravity,view.getLeft()-30,view.getRight()+view.getRight()/3);
		showAtLocation(view, popupGravity, mLocation[0], mLocation[1] + view.getHeight());
		...
		mListView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					...
					ListView.LayoutParams layoutParams = new ListView.LayoutParams(getWidth(),
					...
					// textView.setPadding(mLocation[0], mLocation[1],
					// mLocation[0] + getWidth(),mLocation[1] + v.getHeight());
