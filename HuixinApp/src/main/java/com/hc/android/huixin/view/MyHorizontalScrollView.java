...
public class MyHorizontalScrollView extends HorizontalScrollView implements OnClickListener {
	...
	public void notifyCurrentImgChanged() {
		...
		if (CurrentPosition >= mFirstIndex && CurrentPosition <= mFirstIndex + mCountOneScreen - 1) {
			mContainer.getChildAt(CurrentPosition - mFirstIndex).findViewById(R.id.id_index_gallery_item_image)
	...
	public void initDatas(BaseAdapter mAdapter) {
		...
		if (mChildWidth == 0 && mChildHeight == 0) {
			...
			mCountOneScreen = (mScreenWitdh / mChildWidth == 0) ? mScreenWitdh / mChildWidth + 1
					: mScreenWitdh / mChildWidth + 2;
	...
	public void setAllImgViewBackground() {
		for (int i = 0; i < mContainer.getChildCount(); i++) {
			mContainer.getChildAt(i).findViewById(R.id.id_index_gallery_item_image).setBackgroundColor(Color.BLACK);
		}
	}

	public void setImgViewBackground(int position) {
		CurrentPosition = position;
		// mContainer.getChildAt(position).findViewById(R.id.id_index_gallery_item_image)
		// .setBackgroundResource(R.drawable.bg_shadow_node_img);
	}
